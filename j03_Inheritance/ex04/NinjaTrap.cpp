...
//   Updated: 2015/04/09 16:07:44 by ngoguey          ###   ########.fr       //
//                                                                            //
// ************************************************************************** //
...
NinjaTrap::NinjaTrap(bool) :
	ClapTrap()
{
	std::cout << "Ninja Constructor(bool) called, Yes captain?" <<
		std::endl;
	this->_level = 1;
	this->_class = "SUP3R";
	this->_mana = 120;
...
NinjaTrap::NinjaTrap(std::string const &name, bool) :
	ClapTrap(name)
{
	std::cout << "Ninja Constructor(string, bool) called, Yes captain?" <<
		std::endl;
	this->_level = 1;
	this->_class = "SUP3R";
	this->_mana = 120;
...
NinjaTrap::~NinjaTrap()
{
	std::cout << "Ninja Destructor called, Arrrrrghhh" << std::endl;
	return ;
}
// *************************************************************** OPERATORS //
...
{
	std::cout << "Ninja's trap meleeAttack called" << std::endl;
