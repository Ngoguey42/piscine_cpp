...
//   Updated: 2015/03/30 14:50:43 by ngoguey          ###   ########.fr       //
//                                                                            //
// ************************************************************************** //
...
Form::Form(std::string const &name, int sGrade, int eGrade,
	...
	_target(target)
{
	std::cout << "[Form](std::string const&,int,int,std::string const&)"
...
Form::FormNotSignedException::FormNotSignedException() :
	std::exception()
{
	std::cout << "[FormNotSignedException]() Ctor called" << std::endl;
	return ;
}
...
std::ostream				&operator<<(std::ostream &o, Form const &rhs)
{
	o << "Form(" << rhs.getSGrade() << "," << rhs.getEGrade() <<
		"):"<< rhs.getName() << " target: " << rhs.getTarget() <<
		" signed:" << std::boolalpha << rhs.getIsSigned();
	return (o);
}
